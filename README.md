...
This is a forked version of [tap-salesforce (v1.4.24)](https://github.com/singer-io/tap-salesforce) that maintained by the Broadvoice BI team.

Main differences from the original version:

- The `anytype` data type is now converted to `string`, so AWS Redhsift can read the value correctly
